def area(t): #defining area of a circle function
    area_of_circle=3.14*(t)**2 #formula for finding area of circle
...
while(True):
    ...
    if(r>0):
        ...
        print("enter positive radius of the circle")
    else:
        print("enter non zero Value of radius")